...
from custom_policy import DeepingDQNTorchPolicy
...
class DeepingDQNTrainer(SimpleQTrainer):
    @classmethod
...
@Deprecated(
    new="Sub-class directly from `DeepingDQNTrainer` and override its methods", error=False
)
class GenericOffPolicyTrainer(DeepingDQNTrainer):
    pass